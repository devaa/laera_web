    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h3>Asesoramiento</h3>
          <p>Pondremos a sus disposici&oacute;n profesionales que te explicaran detalladamente el proceso de tu reforma y te ayudaran en la elección de materiales</p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" data-src="holder.js/140x140" alt="Generic placeholder image">
          <h3>Heading</h3>
      ...
      <!-- FOOTER -->
      <footer>
        <h5>Reformas y Decoración Areal S.L. - C/ Buitrago 8 - 28921 ALCORCÓN (MADRID) - 91 611 47 83 - areal@arealsl.es</h5>
      </footer>
